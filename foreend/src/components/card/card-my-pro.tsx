...
import {PageHeader, Tabs, Button, Descriptions, Tag, Modal, Input, Form, InputNumber, message ,Select} from 'antd';
...
class CardMyPRO extends Component<IProps> {
